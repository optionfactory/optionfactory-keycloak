...
import net.optionfactory.keycloak.validation.validators.PhoneNumber.Validator;
...
public @interface PhoneNumber {
    ...
    String message() default "{net.optionfactory.keycloak.validation.validators.PhoneNumber.message}";
